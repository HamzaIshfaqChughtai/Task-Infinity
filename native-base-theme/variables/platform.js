...
export default {
  ...
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#000000' : '#000000',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? 'transparent' : '#3F51B5',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#000000' : '#000000',
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#6b6b6b',
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#FFFFFF' : '#FFFFFF',
  topTabBarBorderColor: platform === PLATFORM.IOS ? Colors.black : Colors.black,
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? Colors.gold : Colors.gold,
